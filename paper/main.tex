...
\(\mathbb{R}^5\) with common angle \(\arccos(1/3)\) [vLS66, LS73,
Tay77]. General absolute and linear-programming bounds for systems of
...
\(\mathbb{R}^5\) is classical [LS73, Tay77, BvM22]. The genuinely
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{figures/fig1_proof_cascade.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{figures/fig2_petersen_scheme.png}}
...
We use this as a black box; the references [vLS66, LS73, Tay77, Sei76,
BvM22] provide the original proofs and an extended modern treatment.
The \((\alpha = 1/3,\, N = 10,\, d = 5)\) case is the maximum case of
the classification of equiangular line systems with common angle
\(\arccos(1/3)\) in Lemmens--Seidel [LS73]; Taylor [Tay77] and
Seidel's survey [Sei76] set out the regular two-graph formalism and
the order-10 uniqueness; Brouwer--Van Maldeghem [BvM22] gives a
...
\(\mathrm{Aut}(K(5,2)) = S_5\) (classical; see e.g.~[God93],
[BCN89]). In the icosahedral geometric realisation, the
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{figures/fig3_schur_obstruction.png}}
...
geometry; see Coxeter [Cox73] for the classical description of this
and related polyhedral compounds.

\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{figures/fig4_hinge_bridge.png}}
...
(\texttt{EXACT\_RANK\_MODE\ =\ False}, the default) that evaluates the
substituted matrices \(L\) and \([L|b]\) at \(20\)-digit precision via
mpmath and applies \texttt{numpy.linalg.matrix\_rank} with tolerance
\(10^{-10}\). This mode is non-binding: it serves only to identify
candidate consistent cases quickly, after which the
...
release; until that point the GitHub commit hash uniquely identifies the
certificate version.
...
[vLS66] J. H. van Lint and J. J. Seidel, \emph{Equilateral point
sets in elliptic geometry}, Proceedings of the Koninklijke Nederlandse
Akademie van Wetenschappen, Series A \textbf{69} (1966), 335--348.

[LS73] P. W. H. Lemmens and J. J. Seidel, \emph{Equiangular lines},
Journal of Algebra \textbf{24} (1973), 494--512.

[DGS75] P. Delsarte, J. M. Goethals and J. J. Seidel, \emph{Bounds
for systems of lines, and Jacobi polynomials}, Philips Research Reports
\textbf{30} (1975), 91--105.

[DGS77] P. Delsarte, J. M. Goethals and J. J. Seidel,
\emph{Spherical codes and designs}, Geometriae Dedicata \textbf{6}
(1977), 363--388.

[CGSS76] P. J. Cameron, J. M. Goethals, J. J. Seidel and E. E.
Shult, \emph{Line graphs, root systems, and elliptic geometry}, Journal
of Algebra \textbf{43} (1976), 305--327.

[Tay77] D. E. Taylor, \emph{Regular 2-graphs}, Proceedings of the
London Mathematical Society (3) \textbf{35} (1977), 257--274.

[Sei76] J. J. Seidel, \emph{A survey of two-graphs}, in: \emph{Atti
del Convegno Internazionale di Teorie Combinatorie (Rome, 1973), Tomo
I}, Accademia Nazionale dei Lincei, Roma, 1976, 481--511.

[BCN89] A. E. Brouwer, A. M. Cohen and A. Neumaier,
\emph{Distance-Regular Graphs}, Ergebnisse der Mathematik und ihrer
Grenzgebiete (3) \textbf{18}, Springer, Berlin, 1989.

[BvM22] A. E. Brouwer and H. Van Maldeghem, \emph{Strongly Regular
Graphs}, Encyclopedia of Mathematics and its Applications \textbf{182},
Cambridge University Press, Cambridge, 2022.

[God93] C. D. Godsil, \emph{Algebraic Combinatorics}, Chapman and
Hall, New York, 1993.

[Wal18] Shayne F. D. Waldron, \emph{An Introduction to Finite Tight
Frames}, Applied and Numerical Harmonic Analysis, Birkhäuser, 2018.

[Cox73] H. S. M. Coxeter, \emph{Regular Polytopes}, 3rd ed., Dover,
New York, 1973.
